...
export default function WelcomeJoel() {
  ...
  const steps = [
    {
      ...
      description: 'For law firms, this means: marketing spend that converts to clients, tech that saves time, staff that drives revenue.'
    },
    {
      id: 'human',
      title: 'Human Capital',
  ...
  const getResultText = (score) => {
    if (score < 50) {
      return {
        ...
        action: "Let's build your delegation framework"
      };
    } else if (score < 75) {
      return {
        ...
        action: "Let's accelerate your growth"
      };
    } else {
      return {
        ...
        action: "Let's scale your success"
      };
    }
  };
        ...
        <div className="max-w-4xl w-full">
          ...
          <div className="mb-8">
            ...
            <div className="w-full bg-white/20 rounded-full h-2">
              <div 
                className="bg-gradient-to-r from-orange-400 to-rose-600 rounded-full h-2 transition-all duration-500"
